/*
 * @parm: Imported Packages 
 * @desc: Below packages imported for implementing their methods.   
 * @author:
 **/

package com.yugasa.navigation;
...
import butterknife.InjectView;
	...
	/*
 	 * @parm: class name MainActivity 
 	 * @desc: This is used for navigation drawer.
	 * @author:
 	 **/

public class MainActivity extends AppCompatActivity {
// using butterknife library for finding ids of view
   ...
   //Creating Activity View
	...
	/*
 	 * @parm: Setting Tabs on Mobile App 
 	 * @desc: Used for Tabs on app.
	 * @author:
 	 **/ 
    ...
    protected void onResume() {
		...
		// lets you scroll to the next screen 
                            Intent edit = new Intent(HomeActivity.this, MapActivity.class);
                            name = "Home";
